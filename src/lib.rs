...
mod tests {
    ...
    fn lmots_test_1() {
        ...
        let k = Sha256Digest::from([0x50, 0x65, 0x0e, 0x3b, 0x31, 0xfe, 0x4a, 0x77, 0x3e, 0xa2, 0x9a, 0x07, 0xf0, 0x9c, 0xf2, 0xea, 0x30, 0xe5, 0x79, 0xf0, 0xdf, 0x58, 0xef, 0x8e, 0x29, 0x8d, 0xa0, 0x43, 0x4c, 0xb2, 0xb8, 0x78]);
        ...
        let q = 5;
        let C: [u8; 32] = [0xd3, 0x2b, 0x56, 0x67, 0x1d, 0x7e, 0xb9, 0x88, 0x33, 0xc4, 0x9b, 0x43, 0x3c, 0x27, 0x25, 0x86, 0xbc, 0x4a, 0x1c, 0x8a, 0x89, 0x70, 0x52, 0x8f, 0xfa, 0x04, 0xb9, 0x66, 0xf9, 0x42, 0x6e, 0xb9];
        ...
        let lms_k  = Sha256Digest::from([0x6c, 0x50, 0x04, 0x91, 0x7d, 0xa6, 0xea, 0xfe, 0x4d, 0x9e, 0xf6, 0xc6, 0x40, 0x7b, 0x3d, 0xb0, 0xe5, 0x48, 0x5b, 0x12, 0x2d, 0x9e, 0xbe, 0x15, 0xcd, 0xa9, 0x3c, 0xfe, 0xc5, 0x82, 0xd7, 0xab]);
        ...
        let final_thingie = verify_lms_signature(5, &LmotsAlgorithmType::LmotsSha256N32W8, &message, &lms_public_identifier, lms_q, &lms_k, &final_lms_sig);
        assert_eq!(final_thingie, true);
        println!("Final thingie is {}", final_thingie);


        let intermediate_hash :[u8; 32] = lms_k.0;
        println!("Intermediate hash is {:?}", intermediate_hash);
        let thingie = verify_lms_signature(5, &LmotsAlgorithmType::LmotsSha256N32W8, &intermediate_hash, &identifier, q, &k, &lms_sig);
        assert_eq!(thingie, true);
        println!("The top of the tree check is {}", thingie);
